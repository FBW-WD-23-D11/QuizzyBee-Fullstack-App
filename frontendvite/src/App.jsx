...
export default function App() {
    ...
    const [timeLeft, setTimeLeft] = useState(30); // Timer-Status
    ...
    const loadQuestion = () => {
        ...
        setAnswers(answers);
        setTimeLeft(30); // Setze den Timer zurück
    };
    ...
    useEffect(() => {
        if (timeLeft === 0) {
            setRightAnswer(false); // Setze Antwort als falsch, wenn die Zeit abgelaufen ist
            setTimeout(() => {
                loadQuestion(); // Neue Frage nach 4 Sekunden
            }, 4000);
        }
        ...
        return () => clearInterval(timer); // Timer aufräumen, wenn die Komponente entladen wird
    }, [timeLeft]);
